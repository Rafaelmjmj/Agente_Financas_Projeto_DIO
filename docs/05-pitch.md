...
### **HOOK — O Problema (30 segundos)**

> **Você sabia que 67% dos brasileiros não têm reserva de emergência?**
>
> E entre jovens profissionais de tecnologia — que ganham bem — ainda assim, **muitos não sabem o que fazer com o dinheiro que sobra**. A informação está espalhada, os jargões financeiros intimidadam, e o medo de perder dinheiro paralisa qualquer decisão.
>
> O resultado? Dinheiro parado na conta corrente, perdendo para a inflação, enquanto sonhos como comprar um apartamento ou viajar pela Europa parecem cada vez mais distantes.
...
> - Meta de entrada para apartamento em 4 anos
>
> E responde: *"Com R$ 5.000, sugiro dividir: R$ 2.000 no Tesouro Selic para completar sua reserva, R$ 2.000 no CDB 120% CDI para o apartamento, e R$ 1.000 no FII HGLG11 para diversificar. O FII tem risco médio e dividendos não são garantidos. Quer que eu simule o rendimento em 1 ano?"*
>
...
### **CLOSE — O Chamado à Ação (45 segundos)**
...
## 📋 Roteiro do Pitch (Para Gravação)
